 ...
 * @Description LayoutAnimationHelper
 */
public class LayoutAnimationHelper {

    private static LayoutAnimationHelper instance = null;

    public static synchronized LayoutAnimationHelper getInstance() {

        if (instance == null) {
            instance = new LayoutAnimationHelper();
        }
     ...
     */
    public void playLayoutAnimation(RecyclerView recyclerView, Animation animation, int order) {
    ...
    public LayoutAnimationController makeLayoutAnimationController() {
     ...
     * @return
     */
    private AnimationSet getAnimationSetFromRight() {
        AnimationSet animationSet = new AnimationSet(true);
        TranslateAnimation translateX1 = new TranslateAnimation(RELATIVE_TO_SELF, 1.0f, RELATIVE_TO_SELF, -0.1f,
                RELATIVE_TO_SELF, 0, RELATIVE_TO_SELF, 0);
        translateX1.setDuration(300);
