package pri.weiqiang.liyuenglish.widget.banner;
...
public class WeakHandler {
    ...
    static class ChainedRef {
        ...
        ChainedRef(@NonNull Lock lock, @NonNull Runnable r) {
            this.runnable = r;
            this.lock = lock;
        ...
        void insertAfter(@NonNull ChainedRef candidate) {
            lock.lock();
            try {
                if (this.next != null) {
        ...
        @Nullable
        WeakRunnable remove(Runnable obj) {
            lock.lock();
            try {
